...
} from "@/features/status/store/slice";
import {
  refreshSyncStatusAction,
...
export function SyncStatusSection() {
  ...
  const mutationStatus = useSelector((state: RootState) =>
    selectMutationSyncStatus(state)
  );
  const messageStatus = useSelector((state: RootState) =>
    selectMessageSyncStatus(state)
  );
  const overallStatus = useSelector((state: RootState) =>
    selectOverallSyncStatus(state)
  );
