...
} from '../slices/syncStatusSlice';
import { selectIsOnline } from '../slices/syncStatusSlice';
...
export function* syncStatusSaga() {
  yield watchStartSyncStatusMonitoring();
  yield watchStartGroupSyncStatus();
  yield watchRefreshSyncStatus();
  yield watchTriggerManualSync();
  // Auto-start monitoring on saga init
